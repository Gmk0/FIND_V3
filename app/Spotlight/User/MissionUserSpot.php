...
class MissionUserSpot extends SpotlightCommand
{
    protected string $name = 'Mission';

    protected string $description = 'Listes de vos mission';
    ...
    {
        $spotlight->redirect('/user/mission-list');
    }
