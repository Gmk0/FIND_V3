...
class MissionFspot extends SpotlightCommand
{



    protected string $name = 'Mission Freelance';

    protected string $description = 'Mission a decouvrir ';
    ...
    {
        $spotlight->redirect('/freelance/mission/en_attente');
    }
