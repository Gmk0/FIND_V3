<div x-show="$store.breakpoints.isXs && $store.global.isSearchbarActive" x-transition:enter="easy-out transition-all"
    ...
    <div class="flex items-center px-3 pt-2 space-x-2 bg-slate-100 dark:bg-navy-800">
        <button
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" stroke-width="1.5" viewBox="0 0 24 24"
                stroke="currentColor">
    ...
    <div class="pb-2 overflow-y-auto is-scrollbar-hidden overscroll-contain">
        <div class="flex px-3 mt-3 space-x-4 overflow-x-auto is-scrollbar-hidden">
            <a href="{{ url('apps/kanban') }}" class="text-center w-14">
            ...
            <a href="{{ url('dashboards/crm-analytics') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
            ...
            <a href="{{ url('apps/chat') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
            ...
            <a href="{{ url('apps/filemanager') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
            ...
            <a href="{{ url('dashboards/crypto-1') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
                    <div class="text-white rounded-full is-initial bg-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ url('dashboards/banking-1') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
            ...
            <a href="{{ url('apps/todo') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
                    <div class="text-white rounded-full is-initial bg-info">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ url('dashboards/orders') }}" class="text-center w-14">
                <div class="w-12 h-12 avatar">
        ...
        <div class="mt-1 font-medium font-inter">
            ...
            <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
                href="{{ url('dashboards/crm-analytics') }}">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-4.5 w-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            ...
            <a class="group flex items-center space-x-2 px-2.5 py-2 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100"
                href="{{ url('dashboards/influencer') }}">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="h-4.5 w-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round"
