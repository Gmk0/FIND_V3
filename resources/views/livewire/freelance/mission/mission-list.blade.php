...
<div>
    @include('include.bread-cumb-freelance',['mission'=>'mission'])
</div>
        ...
        <div class="grid grid-cols-1 gap-4 px-6 mt-4 lg:mt-2 lg:px-0 sm:grid-cols-2 sm:gap-5 lg:gap-6">
            ...
            <div class="card lg:flex-row">
                ...
                <div class="flex flex-col w-full px-4 py-3 grow sm:px-5">
                    ...
                    <div>
                        <a href="{{route('freelance.projet.view',[$projet->id])}}"
                    ...
                    <div class="grow">
                        <div class="flex items-center mt-2 text-xs">
                            <a href="#"
                                ...
                                <div class="w-6 h-6 avatar">
                                    ...
                                    <img class="object-cover rounded-full"
                                        src="{{Storage::disk('local')->url($projet->user->profile_photo_path) }}"
                                        alt="">
                                    @else
                            ...
                            <span
                                class="shrink-0 text-slate-400 dark:text-navy-300">{{$projet->created_at->formatLocalized('%e
                                %B %G')}}
                            </span>
                        </div>
                    </div>
            ...
            <div class="hidden p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="flex justify-between mt-4">
                    <x-button href="{{route('freelance.projet.view',[$projet->id])}}" primary label="voir" />
