                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div>
                        <div class="flex items-center justify-between px-4">
                            ...
                            <div class="-mr-1.5 flex">
                                <button
                                    class="w-6 h-6 p-0 rounded-full btn2 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                        ...
                        <div wire:click="$dispatch('changeChat',{data : {{$conversation}}})"
                            ...
                            <div class="w-10 h-10 avatar">
                                ...
                                <img class="rounded-full"
                                    src="{{Storage::disk('local')->url($conversation->user->profile_photo_path) }}"
                                    alt="avatar" />
                                @else
                                <img class="rounded-full" src="{{$conversation->user?->profile_photo_url}}"
                                    alt="avatar" />

                                @endif

                                @php
                                $online=$conversation->user->is_online?'bg-green-600':'bg-gray-500';
                                @endphp
                    ...
                    <div
                        ...
                        <a href="#" x-tooltip="'Users'"
                            class="p-0 rounded-full btn2 h-9 w-9 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="flex flex-col overflow-y-auto is-scrollbar-hidden grow">
                        <ul class="flex flex-col items-center justify-center mt-2 space-y-1">
                            <li>
                                <a href="#"
                                    class="w-10 h-10 p-0 btn2 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div class="flex flex-col items-center justify-center py-3">
                        <div x-data="usePopper({ placement: 'right-start', offset: 4 })"
                            @click.outside="if(isShowPopper) isShowPopper = false" class="inline-flex">
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="w-10 h-10 p-0 font-medium border rounded-full btn2 border-slate-200 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-500 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" />
