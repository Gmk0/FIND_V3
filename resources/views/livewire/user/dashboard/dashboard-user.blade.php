<div x-data="{ isOpen:false,isLoading: true }" x-init="setTimeout(() => { isLoading = false }, 2000)" class="p-2">
    <div
        ...
        <div x-show="!isLoading" class="grid grid-cols-2 gap-4 px-auto lg:grid-cols-4">
            <a href="{{route('commandeUser')}}" wire:navigate
            ...
            <a href="{{route('transactionUser')}}" wire:navigate
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="flex-col ">
                        <div class="flex items-end ">
                            <span class="text-2xl font-bold text-gray-800 2xl:text-4xl">{{$countTransaction}}</span>
            ...
            <a href="{{route('MissionUser')}}" wire:navigate
                class="px-6 py-6 bg-white rounded-lg shadow-xl cursor-pointer">
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-end">
                            <span class="text-2xl font-bold text-gray-800 2xl:text-4xl">{{$projet}}</span>
                            <div class="flex items-center hidden mb-1 ml-2">
