<div x-data="app()" class="min-h-screen py-3 custom overflow-y-auto-scrollbar bg-gray-50 min-w-screen dark:bg-gray-900">
                    ...
                    <ul class="flex flex-col divide-y divide-gray-700">
                        ...
                        <li class="flex flex-col py-6 sm:flex-row sm:justify-between">
                            <div class="flex w-full space-x-2 sm:space-x-4">
                                <img class="flex-shrink-0 object-cover w-20 h-20 rounded outline-none dark:border-transparent sm:w-32 sm:h-32 dark:bg-gray-500"
                                    src="{{Storage::disk('local')->url($products->files[0]) }}" alt="Polaroid camera">
                        ...
                        <div class="pb-6 mb-6 text-gray-800 border-b border-gray-200">
                            <div class="flex items-center w-full mb-3">
                                ...
                                <div class="pl-3">
                                    <span
                                        class="font-semibold dark:text-gray-50">${{$priceTotal}}</span>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center w-full">
                                ...
                                <div class="pl-3">
                                    <span class="text-sm font-semibold text-gray-400 dark:text-gray-20"></span> <span
                                        class="font-semibold">${{$priceTotal}}</span>
                                </div>
                            </div>
                        </div>
