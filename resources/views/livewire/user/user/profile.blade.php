                ...
                <ul class="mt-6 space-y-1.5 font-inter font-medium">
                    <li>
                        <a @click="activeTab = 'AccountP'"
                            :class="activeTab === 'AccountP' ?'bg-accent':'hover:bg-slate-100 hover:text-slate-800 text-gray-700 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100'"
                            ...
                            <span
                                :class="activeTab === 'AccountP' ?'text-white':'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Comptes
                                Utilisateur</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a @click="activeTab = 'Notification'"
                            :class="activeTab === 'Notification' ?'bg-accent':'hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100'"
                            class=" group flex items-center space-x-2 rounded-lg  px-4 py-2.5 tracking-wide text-white outline-none transition-all "
                            href="#">
                            <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span
                                :class="activeTab === 'Notification' ?'text-white':'text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Notification</span>
                        </a>
                    </li>
                    <li>
                        <a @click="activeTab = 'Security'"
                            :class="activeTab === 'Security' ?'bg-accent':'hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100'"
                            class="group flex items-center space-x-2 rounded-lg  px-4 py-2.5 tracking-wide text-white outline-none transition-all "
                            href="#">
                            <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span
                                :class="activeTab === 'Security' ?'text-white':'transition-colors text-slate-400 group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200'">Security</span>
                        </a>
                    </li>

                    <li>
                        <a @click="activeTab = 'Privacy'"
                            :class="activeTab === 'Privacy' ?'bg-accent':'hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100'"
                            class="group flex items-center space-x-2 rounded-lg  px-4 py-2.5 tracking-wide text-white outline-none transition-all "
                            href="#">
