                    ...
                    <div class="flex items-center justify-between px-4 pt-2">
                        ...
                        <div x-data="usePopper({placement:'bottom-start',offset:4})"
                            ...
                            <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                class="p-0 m-auto rounded-full center h-7 w-7 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
