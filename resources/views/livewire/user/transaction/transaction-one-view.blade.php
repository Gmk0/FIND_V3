    ...
    <section class="grid max-w-6xl gap-1 p-6 mx-auto bg-white rounded-lg shadow dark:text-gray-200 lg:grid-cols-2">
        ...
        <div x-show="!loading" x-cloak>
            ...
            <div class="flex items-center mb-4">
                ...
                <span class="text-gray-900 dark:text-gray-100">{{ $transaction->transaction_number }}</span>
            </div>
        ...
        <div x-show="!loading" x-cloak>
            ...
            <div class="p-6 bg-white rounded-lg ">
                ...
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div class="px-2">
                        ...
                        {{--
                        <x-button flat positive href="{{route('commandeOneView', $order->order_numero)}}" sm
                            label="voir" />--}}
                    </div>
                </div>
            ...
            <div class="p-6 bg-white rounded-lg ">
                ...
                <h2 class="mb-4 text-xl font-semibold">Projet</h2>



                <div class="flex items-center gap-2 mb-4">
                    <span class="mr-2 text-gray-600 dark:text-gray-400"> Projet :</span>
                    <span class="text-gray-900 dark:text-gray-200">{{ $transaction->project->id }}</span>
                    <div>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <span class="text-gray-900 dark:text-gray-200">{{ $transaction->project->created_at }}</span>
                </div>

                <div class="flex items-center mb-4">
                    <span class="mr-2 text-gray-600 dark:text-gray-400">Détails de la commande :</span>
                    <span class="text-gray-900 dark:text-gray-200">{{ $transaction->project->title }}</span>
