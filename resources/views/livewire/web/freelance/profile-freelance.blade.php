<div class="min-h-screen">
    <div class="flex flex-col bg-gray-100 dark:bg-gray-900 lg:flex-row">
        <aside class="w-full bg-white shadow-md lg:w-4/12">
            <div class="p-6">
                @if (!empty($freelance->user->profile_photo_path))
                <img class="w-32 h-32 mx-auto rounded-full"
                    src="{{Storage::disk('local')->url($freelance->user->profile_photo_path) }}" alt="Photo de profil">
                @else
                <img class="w-32 h-32 mx-auto rounded-full"
                    src="{{Storage::disk('local')->url($freelance->user->profile_photo_url) }}" alt="Photo de profil">
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <div class="flex gap-4 mt-4 ">
                        ...
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" class="w-6 h-6 svg3"
                                viewBox="0 0 512 512">
                        ...
                        @case('Twitter')
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" class="w-6 h-6 svg2"
                                viewBox="0 0 512 512">
                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <style>
                                    .svg2 {
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <div>
                        <div class="inline-flex flex-wrap items-center gap-3 mt-4 min:h-12 group">
                            ...
                            @if ($loop->index < 5) <span data-tooltip-target="{{$value}}"
            ...
            <section class="bg-gray-100 dark:bg-gray-800">
                <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center">
                        ...
                        <div class="grid-cols-1 gap-4 mt-8 sm:grid-cols-2 lg:grid-cols-3">
