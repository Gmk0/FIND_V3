...
(function ($) {
    ...
    function myFunction() {
        if ($(window).width() > 1199) {
            if ($(window).scrollTop() > 145) {
                ...
                $('.colors').addClass("colorLevel");


            } else {
                $('.colors').removeClass("colorLevel");
    ...
    function myFunction2() {
        if ($(window).width() > 150) {
            if ($(window).scrollTop() > 145) {
                $('.header-wrap2').addClass("stickyNav animated fadeInDown");
                $('.colors').addClass("colorLevel");


            } else {
                $('.colors').removeClass("colorLevel");
                $('.header-wrap2').removeClass("stickyNav fadeInDown");
            }
        }
    }
